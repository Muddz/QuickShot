...
PixelShot is an awsome Android library that can save any `View` as an image in formats like `JPG/PNG/nomedia` The library works on a asynchronous task behind the scenes and handles errors of I/O operations and manages memory allocation for you.
